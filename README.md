...
# Многофункциональное приложение на Android, включающее:

~ Калькулятор с современным дизайном и закруглёнными кнопками.

~ Медиаплеер для проигрывания локальных аудиофайлов.

~ Geo control (GPS): показывает широту, долготу, высоту и время из location.time, а каждое обновление координат сохраняет в файл location_log.json в папке приложения во внешнем хранилище.
